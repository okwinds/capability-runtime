...
| 宿主等待摘要 / 审批 preview | `help/05-hosted-runtime-and-evidence.md` | `src/capability_runtime/host_protocol.py` | `examples/apps/ui_events_showcase/` | `tests/test_runtime_hitl_host_protocol.py` |
